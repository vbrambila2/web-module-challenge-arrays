...
function addFlavor(arr, addedFlavor){
  arr.unshift(addedFlavor);
  return arr;
}

console.log('task 3', addFlavor(originalFlavors, "Corn"));
...
function removeLastFlavor(arr){
 if(arr.length >= 31) {
   ...
   return "Array is perfect length"
 }
}
